...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_LCTL, KC_LGUI, KC_LALT, LOWER2,  LOWER,   KC_SPC,  KC_SPC,  RAISE,   RAISE2,  KC_RSFT, KC_RALT, KC_RCTRL
),
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, KC_HOME, KC_END,  _______, _______, KC_PGDN, KC_PGUP, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
),

[_RAISE] = LAYOUT_planck_grid(
    KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_MINS, KC_EQL,  _______,
    _______, _______, _______, KC_LPRN, KC_RPRN, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT,LSFT(KC_SCLN),KC_BSLS,
    _______, _______, _______, KC_LCBR, KC_RCBR, _______, _______, KC_LBRC, KC_RBRC, _______, LSFT(KC_SLSH),_______,
...
[_RAISE2] = LAYOUT_planck_grid(
    ...
    _______, KC_F11,  KC_F12,  _______, _______, _______, _______, _______, KC_VOLD, KC_VOLU, _______, KC_MPLY,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_PGDN, KC_PGUP, _______
),
